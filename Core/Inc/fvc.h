...
#define APPS_1_MIN_CURRENT_POS_mm  4.66f  // The position of the pedal at 0% torque, 3.85mm resting + 1mm = 4.85mm
#define APPS_2_MAX_CURRENT_POS_mm  25.00f // The position of the pedal at 100% torque
#define APPS_2_MIN_CURRENT_POS_mm  4.02f  // The position of the pedal at 0% torque, 1.86 mm resting + 1mm = 2.86mm
